 ...
 * Generated for Laravel 5.8.16 on 2019-10-10 20:12:11.
 *
...
namespace App\Facades { 
    ...
    class Base64 {
         ...
         * @static 
         */ 
        public static function save($base64, $name, $path)
        {
                        /** @var \App\Services\Base64 $instance */
                        return $instance->save($base64, $name, $path);
        }
         ...
         * @static 
         */ 
        public static function parseExtension($base64)
        {
                        /** @var \App\Services\Base64 $instance */
                        return $instance->parseExtension($base64);
        }
    ...
    class Base64Validator {
         ...
         * @static 
         */ 
        public static function validate($base64)
        {
                        /** @var \App\Services\Base64Validator $instance */
                        return $instance->validate($base64);
        }
    ...
    class Barcode {
         ...
         * @static 
         */ 
        public static function generate($text, $redeemed = false)
        {
                        /** @var \App\Services\Barcode $instance */
                        return $instance->generate($text, $redeemed);
        }
    ...
    class Identifier {
         ...
         * @static 
         */ 
        public static function generate($prefix, $id, $other_id)
        {
                        /** @var \App\Services\Identifier $instance */
                        return $instance->generate($prefix, $id, $other_id);
        }
    ...
    class Notification {
         ...
         * @static 
         */ 
        public static function sendNotification($token, $title = 'NextCard', $body = 'Text is empty', $data = array(), $sound = 'default', $click_action = null, $icon = null)
        {
                        /** @var \App\Services\Notification $instance */
                        return $instance->sendNotification($token, $title, $body, $data, $sound, $click_action, $icon);
        }
...
namespace  { 
    ...
    class Base64 extends \App\Facades\Base64 {}

    class Base64Validator extends \App\Facades\Base64Validator {}

    class Barcode extends \App\Facades\Barcode {}

    class Identifier extends \App\Facades\Identifier {}

    class FCM extends \LaravelFCM\Facades\FCM {}

    class FCMGroup extends \LaravelFCM\Facades\FCMGroup {}

    class Notify extends \App\Facades\Notification {}
